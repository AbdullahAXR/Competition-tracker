public final class Specs {
    ...
    // team index
    final static int TEAM_INDEX_CELL = 4;
    // team name
    final static int TEAM_NAME_CELL = 5;

    // participant location
    final static int FIRST_PARTICIPANT_ROW = 5;

    // rank location
    final static int INDIVIDUAL_RANK_CELL = 4;
    final static int TEAM_RANK_CELL = 6;
